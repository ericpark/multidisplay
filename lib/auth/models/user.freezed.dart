...
mixin _$User {
  ...
  List<String> get calendars => throw _privateConstructorUsedError;
...
class _$UserImpl implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, firstName: $firstName, lastName: $lastName, email: $email, calendars: $calendars, active: $active)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, firstName, lastName, email,
      const DeepCollectionEquality().hash(_calendars), active);
