...
//@DateTimeConverter() required DateTime date,
  String get id =>
      throw _privateConstructorUsedError; //@DateTimeNullableConverter() DateTime? createdAt,
...
class _$TransactionImpl extends _Transaction {
  _$TransactionImpl({this.id = '', this.description}) : super._();
...
abstract class _Transaction extends Transaction {
  factory _Transaction({final String id, final String? description}) =
      _$TransactionImpl;
  ...
  String get id;
  @override //@DateTimeNullableConverter() DateTime? createdAt,
