...
class SimpleTrackingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final centerStyle = Theme.of(context).primaryTextTheme.displayLarge!;
    final primaryTextStyle = Theme.of(context).primaryTextTheme.headlineSmall!;
    final secondaryTextStyle = Theme.of(context)
        .primaryTextTheme
        .labelLarge!
        .copyWith(fontWeight: FontWeight.bold);
    final tertiaryStyle = Theme.of(context).primaryTextTheme.labelSmall!;
